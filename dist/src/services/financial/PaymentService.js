...
class PaymentService {
    ...
    updateUserStripeCustomer(userId, userEmail) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!userStripe) {
                ...
                userStripe = yield stripeRepository.save(userStripe);
            }
    ...
    updateUserStripePaymentMethod(userId, fingerprint, paymentMethodId, customerId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!userCard) {
                ...
                userCard = yield cardRepository.save(userCard);
            }
    ...
    updateUserStripeSubScription(userId, cardId, customerId, stipePlanId, planId) {
        return __awaiter(this, void 0, void 0, function* () {
            let userSub = yield subScriptionRepository.findByUserId(userId, planId);
            if (!userSub) {
                ...
                userSub = yield subScriptionRepository.save(userSub);
            }
