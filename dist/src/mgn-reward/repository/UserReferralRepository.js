...
class UserReferralRepository extends Repository_1.Repository {
    constructor() {
        super(...arguments);
        this.table = "users_referrals";
    }
    ...
    findByUUID(uuid, conn = null, query = null) {
        return __awaiter(this, void 0, void 0, function* () {
            const c = conn;
            // tslint:disable-next-line:max-line-length
            return c.query(query || `
        select * from ${this.table} where uuid = ${mysql2_1.default.escape(uuid)} and deleted_at is null order by id desc limit 1`).then((results) => results[0] || null);
        });
    }
...
exports.UserReferralRepository = UserReferralRepository;
//# sourceMappingURL=UserReferralRepository.js.map