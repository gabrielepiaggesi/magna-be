...
class AppVersionRepository extends Repository_1.Repository {
    constructor() {
        super(...arguments);
        this.table = "apps_versions";
    }
    findLastActiveAppVersion(conn = null, query = null) {
        return __awaiter(this, void 0, void 0, function* () {
            const c = conn;
            const q = `select * from ${this.table} where deleted_at is null order by id desc limit 1`;
            return yield c.query(query || q).then((results) => results[0] || null);
        });
    }
}
exports.AppVersionRepository = AppVersionRepository;
//# sourceMappingURL=AppVersionRepository.js.map