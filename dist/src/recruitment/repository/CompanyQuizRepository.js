...
class CompanyQuizRepository extends Repository_1.Repository {
    ...
    findByCompanyIdAndQuizId(companyId, quizId, conn, query = null) {
        return __awaiter(this, void 0, void 0, function* () {
            const c = conn;
            // tslint:disable-next-line:max-line-length
            return c.query(query ||
                `select * from ${this.table} where company_id = ${mysql2_1.default.escape(companyId)} and quiz_id = ${mysql2_1.default.escape(quizId)} and deleted_at is null order by id desc limit 1`)
