...
class UserLinkRepository extends Repository_1.Repository {
    constructor() {
        super(...arguments);
    ...
    findByUserIdAndExamId(userId, examId, conn = null, query = null) {
        return __awaiter(this, void 0, void 0, function* () {
            const c = conn;
            // tslint:disable-next-line:max-line-length
            ...
            and link_for = 'EXAM' 
            and entity_id = ${mysql2_1.default.escape(examId)} 
...
//# sourceMappingURL=UserLinkRepository.js.map